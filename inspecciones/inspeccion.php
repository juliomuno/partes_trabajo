  ...
  <div class="container">
    ...
    <div id="div_inspeccion_general" style="display:none;">
      ...
      <div id="nuevoparte1">
        ...
        <div class="form-group">
          <label class="checkbox-inline">
            <?php if ($insp_izacar == 1) {$checked="checked";} else {$checked="";}?>
            <input type="checkbox" name="chk_izacar" value="1" <?php echo $checked;?>> Izado cargas
          </label>
          <label class="checkbox-inline">
            <?php if ($insp_traalt == 1) {$checked="checked";} else {$checked="";}?>
            <input type="checkbox" name="chk_traalt" value="1" <?php echo $checked;?>> Trab. altura
          </label>
          <label class="checkbox-inline">
            <?php if ($insp_traten == 1) {$checked="checked";} else {$checked="";}?>
            <input type="checkbox" name="chk_traten" value="1" <?php echo $checked;?>> Trab. en tensión BT
          </label>
        </div>
