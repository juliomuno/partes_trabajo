...
<html lang="es">
  <head>
    ...
    <?php
      ...
      $num_operarios = 5; // Número de operarios a incluir
  ...
  <script type="text/javascript">
      ...
      function validar_formulario(){ 
        ...
        if (msg != "") {
          ...
          uploadAjax("exe_parte_alumbrado2.php");
        }
      }
...
<body class="framework">
  <div class="container">
    <form name="formulario" id="formulario" class="form-horizontal" role="form" method="POST" action="exe_parte_alumbrado2.php" enctype="multipart/form-data" onsubmit="return false;">
        ...
        echo '<div class="bloque">';
          echo '<div class="form-group bloque-reducido">';
            ...
            echo '<div class="col-lg-10">';
              echo DB_COMBOBOX("LIST_OPERARIOS","Codigo","Nombre","","Nombre","cmb_ope" . $i,"cmb_ope" . $i,"form-control",$par_ope[$i-1]['pd_ope'],"","","cargar('nuevoparte_materiales2.php','capa_materiales');");
            echo '</div>';
          echo '</div>';
          echo '<div class="form-group bloque-reducido">';
            echo '<label for="horas_normales' . $i . '" class="col-xs-3 col-xs-offset-1">Normales:</label>';
            echo '<div class="col-xs-3">';
              echo '<input type="number" class="form-control decimal" id="txt_hnor' . $i . '" name="txt_hnor' . $i . '" value="' . $par_ope[$i-1]['pd_nor'] . '"/>';
            echo '</div>';
            echo '<label for="horas_extras' . $i . '" class="col-xs-2">Extras:</label>';
            echo '<div class="col-xs-3">';
              echo '<input type="number" class="form-control decimal" id="txt_hext' . $i . '" name="txt_hext' . $i . '" value="' . $par_ope[$i-1]['pd_ext'] . '"/>';
            echo '</div>';
          echo '</div>';
        echo '</div>';
    } ?>  
