    ...
    <div id="nuevoparte1">
      ...
      <div class="bloque">
        <div class="form-group bloque-reducido">
          ...
          <div class="col-lg-10">
            <?php echo DB_COMBOBOX("LIST_OPERARIOS","Codigo","Nombre","","Nombre","cmb_ope2","cmb_ope3","form-control",$par_ope[2]['pd_ope'],"","",""); ?>
          </div>
        </div>
        <div class="form-group bloque-reducido">
      ...
      <div class="bloque">
        <div class="form-group bloque-reducido">
          ...
          <div class="col-lg-10">
            <?php echo DB_COMBOBOX("LIST_OPERARIOS","Codigo","Nombre","","Nombre","cmb_ope4","cmb_ope4","form-control",$par_ope[3]['pd_ope'],"","",""); ?>
          </div>
        </div>
        <div class="form-group bloque-reducido">
    ...
    <div id="nuevoparte2" style="display:none">
      ...
      <div class="bloque">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10">
            <?php echo DB_COMBOBOX("LIST_TIPOS_AVERIAS","Codigo","Nombre","","Nombre","cmb_tip_ave","cmb_tip_ave","form-control",$par_tip_ave,"","",""); ?>
          </div>
        </div>
