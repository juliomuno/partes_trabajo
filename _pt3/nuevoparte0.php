...
<body class="framework">
  <div class="container">
    <form name="formulario" id="formulario" class="form-horizontal" role="form" method="POST" action="exe_parte0.php" enctype="multipart/form-data" onsubmit="return false;">
    ...
    <div id="nuevoparte4" style="display:none">
      ...
      <div id="capa_materiales">
      	<h4>Materiales</h4>
      	Indique los materiales en el campo Observaciones mientras no funciona este módulo.
      </div>
    </div>
    <!-- Fin Nuevo Parte 4/7 -->
