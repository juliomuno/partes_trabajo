    ...
    <div id="capa_geolocalización" style="display:none;">
      ...
      <div class="bloque">
        ...
        <div id="capa_planificacion" style="display:none;">
          ...
          <?php 
            //echo DB_LIST_CHECK("LIST_PLANIFICACION_JEF INNER JOIN USR_WEB ON USR_WEB.USR_ID=LIST_PLANIFICACION_JEF.Operario","Operario","CONCAT_WS(' ',USR_NOM,USR_APE)","PEE_ID=".$row['PEE_ID']." AND JEFE=0","","chk_pla_ope","","","onchange=javascript:registrar_seleccion_opes(".$row['PEE_ID'].",this.value,this.checked);","");
          ...
          //$condicion="PEE_ID=".$row['PEE_ID']." AND JEFE=0";
          ...
          if ($pre_ptes_ini_jef!=""){
            ?>
            <tr><td><strong>Presupuestos PENDIENTES DE INICIAR por el jefe de trabajo</strong><br><?php echo $pre_ptes_ini_jef; ?></td></tr>
            <?php
          }

          if ($_SESSION['GLB_USR_OFI']==0){
            ...
            while ($row = mysql_fetch_assoc($sentencia)) { 
                ...
                <tr>
                  <td class="detalle_fila" onclick="javascript: document.getElementById('txt_pee').value=<?php echo $row['UJ_PEE']?>;document.getElementById('txt_jef').value=0;ejecuta('');">
                    <table style="width:100%;">
                        <tr>
                            <td class="id_registro">INICIADO POR: <strong><?php echo $row['jefe_nombre']; ?></td>
                            <td align="right"></td>
                        </tr>
                        <tr>
          ...
          ?>
            <tr><td><br><br></td></tr>
            <tr><td><strong>INICIAR TRABAJO SIN PLANIFICAR</strong><br>Solo se podrá añadir operarios que tengan inicio de jornada.</td></tr>
            <tr>
              <td class="detalle_fila" onclick="javascript: document.getElementById('txt_pee').value=-<?php echo $_SESSION['GLB_USR_ID'] . str_replace(":","",date("H:i:s")); ?>;document.getElementById('txt_jef').value=1;ejecuta('');">
                <table style="width:100%;">
                    <tr>
                        <td class="id_registro"><strong>INICIAR TRABAJO sin planificar</td>
                        <td align="right"></td>
                    </tr>
                    <tr>
                        <td colspan="2">NUEVO PARTE. Trabajo sin planificar.</td>
                    </tr>
                    <tr>
                        <td colspan="2"></td>
                    </tr>
            ...
            <tr>
                ...
                <?php 
                if ($bofi!=1){
                  //echo DB_LIST_CHECK("LIST_OPERARIOS_DISPONIBLES_HOY","UJ_USU","Operario","UJ_USU<>" . $_SESSION['GLB_USR_ID'],"Operario","chk_pla_ope","","","onchange=javascript:registrar_seleccion_opes(-1,this.value,this.checked);");
                  echo DB_LIST_CHECK_OPE_DISPONIBLES("LIST_OPERARIOS_DISPONIBLES_HOY","UJ_USU","Operario","UJ_USU<>" . $_SESSION['GLB_USR_ID'] . " AND USR_JOR_INI=1","Operario","chk_pla_ope","","","onchange=javascript:registrar_seleccion_opes(-1,this.value,this.checked);");
                }
                ?>
                </td>
              </tr>
