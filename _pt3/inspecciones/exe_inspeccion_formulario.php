...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
	...
	foreach( $vpreguntas as $clave => $valor ) {
		...
		if ($nombre_archivo != '') {
			...
			if (!((strpos($tipo_archivo, "gif") || strpos($tipo_archivo, "jpeg")) && ($tamano_archivo < 3000000))) { 
				...
				$respuesta->mensaje = "La extensión o el tamaño de los archivos no es correcta. <br><br><table><tr><td><li>Se permiten archivos .gif o .jpg<br><li>Se permiten archivos de 3 MB máximo.</td></tr></table>"; 
			}
		}
	}
	...
	if (!$respuesta->error) {
		...
		//marcar inspección para bajar pdf
