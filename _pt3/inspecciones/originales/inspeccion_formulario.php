...
<body class="framework">
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Guardar Formulario <?php echo $nombre_formulario?></h4>
          </div>
    ...
    <div id="nuevoparte1">
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <p class="titulo">Formulario <?php echo $nombre_formulario?></p>
      </nav>
			<?php 
			if ($op == 'C') {
          ...
          <div class="row">
              ...
              <div class="form-group">
  	 				  <?php echo DB_COMBOBOX("RESP","RESP_ID","RESP_NOM","","RESP_NOM","cmb_resp[]","cmb_resp[]" ,"form-control","","","","");?>
  	 				  </div>
              <!-- ./form-group -->
            </div>
            <!-- ./col -->
