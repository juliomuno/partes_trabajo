...
<body class="framework">
    ...
    <div id="nuevoparte1">
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
              ...
              <p class="titulo">Nuevo Parte 1/4</span>
      </nav>
      ...
      <div class="bloque">
        <div class="form-group bloque-reducido">
          ...
          <div class="col-lg-10">
            <?php echo DB_COMBOBOX("LIST_OPERARIOS","Codigo","Nombre","","Nombre","cmb_ope2","cmb_ope2","form-control",$par_ope[1],"","",""); ?>
          </div>
        </div>
      </div>
    ...
    <div id="nuevoparte2" style="display:none">
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
              ...
              <p class="titulo">Nuevo Parte 2/4</span>
      </nav>
    ...
    <div id="nuevoparte3" style="display:none">
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
              ...
              <p class="titulo">Nuevo Parte 3/4</span>
      </nav>
    ...
    <div id="nuevoparte4" style="display:none">
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
              ...
              <span class="navbar-right" style="visibility:hidden;"><a href="javascript: habilitar_capa('nuevoparte4');" class="btn btn-primary"><i class="fa fa-arrow-right"></i> Sig.</a></span>
              <p class="titulo">Nuevo Parte 4/4</span>
      </nav>
