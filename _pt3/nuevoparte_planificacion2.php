    ...
    <script type="text/javascript">
      ...
      function validar_formulario(){ 
        ...
        if (msg != "") {
          ...
          uploadAjax("exe_parte_planificacion2.php");
        }
      }
...
<body class="framework">
    <div class="container">
    <form name="formulario" id="formulario" class="form-horizontal" role="form" method="POST" action="exe_parte_planificacion2.php" enctype="multipart/form-data" onsubmit="return false;">
