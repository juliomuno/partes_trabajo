  ...
  <div class="container">
    ...
    <div id="capa_contenidos">   	  
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <li>
          <a href="javascript: buscar_imagen('INI_DES');" data-toggle="" class="icono btn btn-primary btn-block" id="boton_inicio_descanso"><i class="fa fa-hourglass-o fa-3x"></i>Inicio Descanso</a>
        </li>

        <li>
          <a href="javascript: buscar_imagen('FIN_DES');" data-toggle="" class="icono btn btn-primary btn-block" id="boton_fin_descanso"><i class="fa fa-hourglass fa-3x"></i>Fin Descanso</a>
        </li>
