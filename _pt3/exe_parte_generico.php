...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
	...
	$pd_hnor = $_REQUEST['txt_hnor']; //restar_horas($_REQUEST['txt_hini'], $_REQUEST['txt_hfin']);
	...
	if (!$respuesta->error) {
		if ($op == "C") {
			$sSQL = "INSERT INTO PAR (PAR_ID, PAR_TIP, PAR_FEC_REA, PAR_FEC, PAR_HINI, PAR_HFIN, PAR_NINC, PAR_DIR, PAR_POB, PAR_CLI_NOM, PAR_REA, PAR_OBS, PAR_MOD) ";
			$sSQL .= "VALUES (" . $par_id . ", " . $par_tip . ", " . $par_fec_rea . ", " . $par_fec . ", " . $par_hini . ", " . $par_hfin . ", " . $par_ninc . ", " . $par_dir . ", " . $par_pob . ", " . $par_cli_nom . ", " . $par_rea . ", " . $par_obs . ", 1)";
		} else {
			$sSQL = "UPDATE PAR SET ";
	...
	/** -------- Para finalizar el trabajo en parte genérico ---------- */
