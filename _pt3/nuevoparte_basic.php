  ...
  <script type="text/javascript">
      ...
      function validar_formulario(){ 
        ...
        if (msg != "") {
          ...
          uploadAjax("exe_parte_basic.php");
        }
      }
...
<body class="framework" onload="javascript: marcar_conductores();">
	<div class="container">
    <form name="formulario" id="formulario" class="form-horizontal" role="form" method="POST" action="exe_parte_basic.php" enctype="multipart/form-data" onsubmit="return false;">
