  ...
  <div class="container">
    ...
    <div id="capa_contenidos">   	  
      ...
      <ul class="lista-botones">
        ...
        <li>
          <a href="javascript: buscar_geolocalizacion('INI_TRA');" data-toggle="" class="icono btn btn-primary btn-block" id="boton_inicio_trabajo"><i class="fa fa-file fa-3x"></i>Inicio Trabajo<?php echo $tra_ini_str;?></a>
    		</li>
    ...
    <div id="capa_geolocalización" style="display:none;">
      ...
      <div class="bloque">
        ...
        <div id="capa_vehiculo" style="display:none;">
          ...
          <div class="col-xs-6 mb-lg-4 mt-lg-4">
        ...
        <div id="capa_planificacion" style="display:none;">
          ...
          ?>
            ...
            <tr>
              ...
              <!-- subir_multiples_imagenes($_SESSION['GLB_USR_ID'], $_FILES['foto']); -->
