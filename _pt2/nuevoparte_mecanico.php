    ...
    <script type="text/javascript">
      ...
      function horas_normales(){
        ...
        if (aux<0){
          ...
          //msg = "Las horas Extras no puede ser superior a: " + hor;
    ...
    <div id="nuevoparte1">
      ...
      <div class="bloque">
        <div class="form-group bloque-reducido">
          ...
          <div class="col-lg-10">
            <?php echo DB_COMBOBOX("LIST_OPERARIOS","Codigo","Nombre","","Nombre","cmb_ope1","cmb_ope1","form-control",$par_ope[0],"","1","javascript: marcar_conductores();"); ?>
            <input type="hidden" name="txt_ope_sel1" id="txt_ope_sel1">
            <input type="hidden" id="txt_ope1" name="txt_ope1" value="<?php echo $par_ope[0] ?>">
          ...
          <div class="col-xs-6 bloque">
            ...
            <input type="number" class="form-control decimal" id="txt_hnor1" name="txt_hnor1" disabled="disabled" value="<?php echo $hor_dif; ?>" />
            <input type="hidden" id="txt_hnor_1" name="txt_hnor_1" value="<?php echo $hor_dif;?>" />
          </div>
          <div class="col-xs-6 bloque">
            <label for="horas_extras1" class="">Extras:</label>
              <input type="number" class="form-control decimal" id="txt_hext1" name="txt_hext1" onchange="javascript:horas_normales();" <?php echo $horas_disabled;?> value="<?php echo $hor_ext;?>" />
          </div>
        </div>
      </div>
      ...
      <?php
        if ($pee_id!=""){
          ...
          <div class="col-lg-10">
            ...
            <?php 
            echo DB_LIST_CHECK_PARTES("UJ_PLA_JEF=0 AND UJ_FEC_FIN IS NULL AND UJ_FEC_INI>=CURDATE() AND UJ_PEE=".$pee_id,"","","onchange=javascript:registrar_seleccion_opes(this.value,this.checked);","2",$op);
            ?>
          </div>
          <?php
          }
    ...
    <div id="nuevoparte4" style="display:none">
        ...
        <div class="input-group form-group">
          <span class="input-group-btn">
              <span class="btn btn-primary btn-file">
                Seleccionar&hellip; <input type="file" id="txt_img1" name="txt_img1" accept=".jpg,.jpeg" multiple="multiple">
              </span>
          </span>
      ...
      <div class="col-xs-12">
        <div class="input-group form-group">
          <span class="input-group-btn">
              <span class="btn btn-primary btn-file">
                Seleccionar&hellip; <input type="file" id="txt_img4" name="txt_img4[]" value="txt_img4[]" accept=".jpg,.jpeg" multiple="multiple">
              </span>
          </span>
