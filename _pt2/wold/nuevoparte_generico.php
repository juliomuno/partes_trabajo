    ...
    <div id="nuevoparte1">
      ...
      <div class="bloque">
        <div class="form-group bloque-reducido">
          ...
          <div class="col-lg-10">
            <?php echo DB_COMBOBOX("LIST_OPERARIOS","Codigo","Nombre","","Nombre","cmb_ope","cmb_ope","form-control",$par_ope,"","","javascript: marcar_conductores(); cargar('nuevoparte_materiales.php?par_id=" . $par_id . "&ope1=' + this.value + '&ope2=0&ope3=0&ope4=0', 'capa_materiales');"); ?>
