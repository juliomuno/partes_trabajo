...
<html lang="es">
  ...
  <script type="text/javascript">
    ...
    function valida_enter(e) {
      ...
      if (tecla == 13) {
        cargar('list_documentacion.php?criterio=' + document.formulario.txt_buscar.value,'capa_documentacion');  
    ...
    window.onload = function() {
      cargar('list_documentacion.php','capa_documentacion');
    }
      ...
      <div class="bloque" id="capa_filtros">
        <div class="input-group bloque-reducido">
          ...
          <span class="input-group-btn">
            <span class="btn btn-default" onclick="javascript: document.formulario.txt_buscar.value='';document.formulario.txt_buscar.focus();cargar('list_documentacion.php?criterio=','capa_documentacion');"><i class="fa fa-times"></i></span>
          </span>
          <span class="input-group-btn">
            <button class="btn btn-primary" type="button" id="cmd_buscar" onclick="javascript: cargar('list_documentacion.php?criterio=' + document.formulario.txt_buscar.value,'capa_documentacion');">Buscar</button>
          </span>
        </div>
      </div>
