  ...
  <script type="text/javascript">
      ...
      function vehiculos_add() {
        ...
        cadena += '<div class="form-group bloque-reducido">';
          ...
          cadena += '<?php echo DB_COMBOBOX("LIST_VEHICULOS","Codigo","Nombre","","Nombre","cmb_veh[]","cmb_veh[]","form-control",$par_veh,"","",""); ?>';
          cadena += '</div>';
        cadena += '</div>';
        cadena += '<div class="form-group bloque-reducido">';
          cadena += '<label for="conductor" class="col-lg-2">Conductor:</label>';
          cadena += '<div class="col-lg-10">';
          cadena += '<?php echo DB_COMBOBOX("LIST_OPERARIOS","Codigo","Nombre","","Nombre","cmb_cond[]","cmb_cond[]","form-control","","","",""); ?>';
          cadena += '</div>';
        cadena += '</div>'
        cadena += '<div class="form-group">';
          ...
          cadena += '<div class="col-xs-3">';
          cadena += '<input type="number" class="form-control decimal" id="txt_km_hor[]" name="txt_km_hor[]" value="<?php echo $par_km_hor;?>"  />';
          cadena += '</div>';
        cadena += '</div>';
...
<body class="framework">
  <div class="container">
    <form name="formulario" id="formulario" class="form-horizontal" role="form" method="POST" action="exe_parte.php" enctype="multipart/form-data" onsubmit="return false;">
    ...
    <div id="nuevoparte5" style="display:none">
      ...
      <div id="capa_vehiculos">
        <div class="form-group bloque-reducido">
          <label for="vehiculo" class="col-lg-2">Veh&iacute;culos:</label>
          <div class="col-lg-10">
            <?php echo DB_COMBOBOX("LIST_VEHICULOS","Codigo","Nombre","","Nombre","cmb_veh[]","cmb_veh[]","form-control",$par_veh,"","",""); ?>
          </div>
        </div>
        <div class="form-group bloque-reducido">
          <label for="conductor" class="col-lg-2">Conductor:</label>
          <div class="col-lg-10">
            <?php echo DB_COMBOBOX("LIST_OPERARIOS","Codigo","Nombre","","Nombre","cmb_cond[]","cmb_cond[]","form-control","","","",""); ?>
          </div>
        </div>
        <div class="form-group">
