    ...
    <div id="capa_geolocalización" style="display:none;">
      ...
      <div class="bloque">
        ...
        <div id="capa_planificacion" style="display:none;">
          ...
          ?>
            <tr><td><br><br></td></tr>
            <tr><td><strong>INICIAR TRABAJO SIN PLANIFICAR</strong></td></tr>
            <tr>
            ...
            <tr>
                ...
                if ($bofi!=1){
                  ...
                  if (date("w")==0 || date("w")==6 || date("G")<6 || date("G")>15){
                    ...
                    echo DB_LIST_CHECK_OPE_DISPONIBLES("LIST_OPERARIOS_DISPONIBLES_HOY","UJ_USU","Operario","UJ_USU<>" . $_SESSION['GLB_USR_ID'],"Operario","chk_pla_ope","","","onchange=javascript:registrar_seleccion_opes(-1,this.value,this.checked);");
                  } else {
