  ...
  <script type="text/javascript">
    ...
    function obtener_localizacion() {
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(coordenadas,gestiona_errores, options_localizacion);
      }else{
    ...
    $(document).ready( function() {
      ...
      // Sólo se permiten 7 dígitos para el Nº de Orden
    ...
    <div id="nuevoparte1">
      ...
      <div class="bloque">
        <div class="form-group bloque-reducido">
          ...
          <div class="col-lg-10">
            <?php echo DB_COMBOBOX("LIST_OPERARIOS","Codigo","Nombre","","Nombre","cmb_ope","cmb_ope","form-control",$par_ope,"","",""); ?>
          </div>
        </div>
      </div>
